                ...
                if (price.equals("sorted_by_ascending_price")) {
                    ...
                    if (!category.isEmpty()) {
                        ...
                        if (category.equals("flowers")) {
                            ...
                            // Если категория равная комнатным растениям
                        } else if (category.equals("houseplants")) {
                            ...
                            // Если категория равная садовым растениям
                        } else if (category.equals("gardenPlants")) {
                            ...
                            // Если категория равная грунт и удобрение
                        } else if (category.equals("soilAndFertilizer")) {
                            ...
                            // Если категория равная аксессуарам
